...
export function Header() {
  ...
  return (
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-5xl">
      <nav className="flex h-14 items-center justify-between rounded-full bg-white/70 px-6 shadow-lg shadow-neutral-900/5 backdrop-blur-xl dark:bg-neutral-900/70 dark:shadow-neutral-900/30">
        <a
          href="#hero"
